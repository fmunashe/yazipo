...
class CaseFilePolicy
{
    ...
    public function viewAny(User $user): bool
    {
        return $user->roles()->whereHas('permissions', function ($query) {
            $query->where('title', 'case_file_access');
        })->exists();
    }
    ...
    {
        return $user->roles()->whereHas('permissions', function ($query) {
            $query->where('title', 'case_file_show');
        })->exists();
    }
    ...
    {
        return $user->roles()->whereHas('permissions', function ($query) {
            $query->where('title', 'case_file_create');
        })->exists();
    }
    ...
    {
        return $user->roles()->whereHas('permissions', function ($query) {
            $query->where('title', 'case_file_edit');
        })->exists();
    }
    ...
    {
        return $user->roles()->whereHas('permissions', function ($query) {
            $query->where('title', 'case_file_delete');
        })->exists();
    }
