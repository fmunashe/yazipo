...
class SchoolReportPolicy
{
    ...
    public function viewAny(User $user): bool
    {
        return $user->roles()->whereHas('permissions', function ($query) {
            $query->where('title', 'school_report_access');
        })->exists();
    }
    ...
    {
        return $user->roles()->whereHas('permissions', function ($query) {
            $query->where('title', 'school_report_show');
        })->exists();
    }
    ...
    {
        return $user->roles()->whereHas('permissions', function ($query) {
            $query->where('title', 'school_report_create');
        })->exists();
    }
    ...
    {
        return $user->roles()->whereHas('permissions', function ($query) {
            $query->where('title', 'school_report_edit');
        })->exists();
    }
    ...
    {
        return $user->roles()->whereHas('permissions', function ($query) {
            $query->where('title', 'school_report_delete');
        })->exists();
    }
