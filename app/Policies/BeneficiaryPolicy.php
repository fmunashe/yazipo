...
class BeneficiaryPolicy
{
    ...
    public function viewAny(User $user): bool
    {
        return $user->roles()->whereHas('permissions', function ($query) {
            $query->where('title', 'beneficiary_access');
        })->exists();
    }
    ...
    {
        return $user->roles()->whereHas('permissions', function ($query) {
            $query->where('title', 'beneficiary_show');
        })->exists();
    }
    ...
    {
        return $user->roles()->whereHas('permissions', function ($query) {
            $query->where('title', 'beneficiary_create');
        })->exists();
    }
    ...
    {
        return $user->roles()->whereHas('permissions', function ($query) {
            $query->where('title', 'beneficiary_edit');
        })->exists();
    }
    ...
    {
        return $user->roles()->whereHas('permissions', function ($query) {
            $query->where('title', 'beneficiary_delete');
        })->exists();
    }
