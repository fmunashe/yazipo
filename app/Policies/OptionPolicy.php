...
class OptionPolicy
{
    ...
    public function viewAny(User $user): bool
    {
        return $user->roles()->whereHas('permissions', function ($query) {
            $query->where('title', 'option_access');
        })->exists();
    }
    ...
    {
        return $user->roles()->whereHas('permissions', function ($query) {
            $query->where('title', 'option_create');
        })->exists();
    }
    ...
    {
        return $user->roles()->whereHas('permissions', function ($query) {
            $query->where('title', 'option_delete');
        })->exists();
    }
